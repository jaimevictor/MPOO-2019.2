...
import br.ufrpe.revcare.duende.gui.RecyclerViewDuende;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnDuende = findViewById(R.id.botaoEntrarDuende);
        ...
        btnDuende.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                finish();
                startActivity(new Intent(MainActivity.this, RecyclerViewDuende.class));
            }
