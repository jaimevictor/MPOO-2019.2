...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String TABELA_DUENDE = "Tabela_Duende";
    public static final String COL_ID_DUENDE = "id_duende";
    ...
    private static final String[] TABELAS = {
            ...
            TABELA_AVALIACAO,TABELA_DUENDE
    };
    ...
    private void createTableDuende(SQLiteDatabase db) {
        String sqlTbDuende = SQL_CREATE_TABLE + "( " +
                SQL_INTEGER_AUTOINCREMENT +
                " %3$s TEXT NOT NULL, " +
                " %4$s TEXT NOT NULL, " +
                " %5$s TEXT NOT NULL, " +
                ...
                " %7$s TEXT NOT NULL " +
                ");";
        sqlTbDuende = String.format(sqlTbDuende,
                TABELA_DUENDE, COL_ID_DUENDE, COL_NOME, COL_CPF, COL_EMAIL, COL_ALTURA, COL_SENHA);
        db.execSQL(sqlTbDuende);
    }
